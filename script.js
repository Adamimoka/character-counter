...
function countLettersButtonPressed() {
    ...
    if (inputType === "text") {
        ...
        if (document.getElementById("sample1").checked) {
            linkInput = "https://raw.githubusercontent.com/Adamimoka/character-counter/refs/heads/main/samples/words_alpha.txt"
        }
        else if (document.getElementById("sample2").checked) {
            linkInput = "https://raw.githubusercontent.com/Adamimoka/character-counter/refs/heads/main/samples/common_words.txt"
        }
        else if (document.getElementById("sample3").checked) {
            linkInput = "https://raw.githubusercontent.com/Adamimoka/character-counter/refs/heads/main/samples/the_raven.txt"
        }
        else {
